        ...
        <div className="w-11/12 mx-auto my-20 relative">
            <div className='grid grid-cols-1'>
                <div className="max-h-full">
                    <h1 className="text-6xl font-semibold text-outline absolute uppercase">Contact</h1>
                    <h1 className='text-4xl mt-6 font-semibold text-center text-primary'>How to reach us</h1>
                    <div className="mx-auto w-11/12 mt-4 mb-8">
